 ...
 * {@link TerminalView} through {@link TerminalView#setRemoteTerminalViewClient(RemoteTerminalViewClient)}.
 */
public interface RemoteTerminalViewClient {
    ...
    boolean onCodePoint(int codePoint, boolean ctrlDown, RemoteTerminalController session);
