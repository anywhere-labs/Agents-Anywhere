...
public class TextSelectionHandleView extends View {
    ...
    public TextSelectionHandleView(RemoteTerminalView terminalView, CursorController cursorController, int initialOrientation) {
    ...
    private void checkChangedOrientation(int posX, boolean force) {
        ...
        final RemoteTerminalView hostView = terminalView;
