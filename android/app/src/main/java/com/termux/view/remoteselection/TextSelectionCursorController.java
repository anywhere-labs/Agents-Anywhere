package com.termux.view.remoteselection;
...
public class TextSelectionCursorController implements CursorController {
    ...
    private final RemoteTerminalView terminalView;
    ...
    public TextSelectionCursorController(RemoteTerminalView terminalView) {
    ...
    public void setActionModeCallBacks() {
        final ActionMode.Callback callback = new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                menu.add(Menu.NONE, ACTION_COPY, Menu.NONE, R.string.common_copy).setShowAsAction(show);
                return true;
            }
    ...
    private void copySelectedTextToClipboard() {
        ...
        if (clipboard != null) {
            clipboard.setPrimaryClip(ClipData.newPlainText("terminal", selectedText));
        }
    }
