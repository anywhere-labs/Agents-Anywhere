...
This revision is retained because it may already be recorded in deployed or
local databases. The queue schema is retired by v2_22.
"""
...
def downgrade() -> None:
    ...
    if "session_message_queue" in inspector.get_table_names():
        indexes = {
            index["name"] for index in inspector.get_indexes("session_message_queue")
        }
