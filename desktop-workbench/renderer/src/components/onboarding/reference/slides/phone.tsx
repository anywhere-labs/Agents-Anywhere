...
export function PhoneSlide({ onNext, onConnect }: PhoneSlideProps) {
  return (
    <SlideFrame
      id="phone"
      title={"Agent 在工作。\n你，尽管自由。"}
      ...
      actions={<>
        ...
        {onNext ? <Button variant="ghost" size="lg" onClick={onNext}>下一步<ArrowRightIcon data-icon="inline-end" /></Button> : null}
      </>}
    />
  )
}
