...
const desktopMessages = {
  en: {
    ...
    startFromCommand: "Start from command or credentials",
    logs: "Logs",
    ...
    server: "Server",
    commandTitle: "Start from command or credentials",
    commandDescription: "Paste a start command or credential text generated by the web console.",
    ...
    commandLabel: "Start command or credential text",
    ...
    commandActionDescription: "Paste the start command or credential text generated in the web console.",
  ...
  zh: {
    ...
    pairingFailed: "配对失败",
    server: "服务器",
    commandTitle: "从命令或凭据启动",
    commandDescription: "粘贴 Web 控制台生成的启动命令或凭据文本。",
    ...
    commandActionDescription: "粘贴 Web 控制台生成的启动命令或凭据文本。",
