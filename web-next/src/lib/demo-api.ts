...
const mockSessions: SessionView[] = [
  ...
  { id: "s6", connectorId: "conn-4", connectorStatus: "offline", runtime: "Claude", title: "这是猫还是老鼠", cwd: null, status: "waiting_approval", takeover: false, pinned: false, archived: false, unread: true, lastReadSeq: 2, updatedSeq: 5, updatedAt: "昨天" },
