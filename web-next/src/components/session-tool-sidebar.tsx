    ...
    >
      {controller.open && !fillsMain ? (
        <div
          ...
          aria-valuenow={width}
          tabIndex={0}
          className="absolute inset-y-0 left-0 z-20 w-2 cursor-col-resize touch-none bg-transparent focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
      ...
      {discardDialog}
      <div className={cn("flex h-14 shrink-0 items-center gap-1 bg-background px-2", fillsMain && "pl-12")}>
        <div
          role="tablist"
