...
export const zh = {
  ...
  'overview.stop': '停止',
  'overview.restart': '重启',
  'overview.install.title': '安装 anywhere-cli',
  'overview.install.description': '首次使用需要安装 Python 连接器 CLI。',
  'overview.install.button': '一键安装',
  'overview.install.running': '正在安装…',
  'overview.installed': 'anywhere-cli v{version} 已安装',
...
export const en = {
  ...
  'overview.install.title': 'Install anywhere-cli',
  'overview.install.description': 'A one-time install of the Python connector CLI is required.',
  'overview.install.button': 'Install now',
  'overview.install.running': 'Installing…',
  'overview.installed': 'anywhere-cli v{version} installed',
  'overview.metric.connector.title': 'Connector',
